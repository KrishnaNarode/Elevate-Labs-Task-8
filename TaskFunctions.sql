...
-- task 8:
-- 1. Simple Procedure with parameter
DELIMITER //
...
-- 2. Simple Function with conditional logic
DELIMITER //
CREATE FUNCTION OrderCategory(amount DECIMAL(10,2))
RETURNS VARCHAR(20)
DETERMINISTIC
BEGIN
   IF amount >= 3000 THEN
...
SELECT order_id, amount, OrderCategory(amount) AS category
FROM Orders;
